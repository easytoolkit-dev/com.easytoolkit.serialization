...
namespace EasyToolkit.Serialization.Tests
{
    ...
    public class TestBinarySerializer
    {
        ...
        public void SerializeDeserialize_DerivedClassWithRuntimeTypeEnabled_PreservesRuntimeType()
        {
            ...
            // Act
            byte[] data = EasySerializer.SerializeToBinary(original, null, context);
            var result = EasySerializer.DeserializeFromBinary<PetContainer>(data, null, context);
        ...
        public void SerializeDeserialize_MultipleDerivedClassesWithRuntimeTypeEnabled_PreservesAllRuntimeTypes()
        {
            ...
            // Act
            byte[] data = EasySerializer.SerializeToBinary(original, null, context);
            var result = EasySerializer.DeserializeFromBinary<ZooContainer>(data, null, context);
